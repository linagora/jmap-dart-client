...
void main() {
  group('test to json get pushSubscription method', () {
    ...
    test('get pushSubscription method and response parsing', () async {
      ...
      final getPushSubscriptionInvocation = requestBuilder.invocation(getPushSubscriptionMethod);
      final response = await (requestBuilder
            ..usings(getPushSubscriptionMethod.requiredCapabilities))
          .build()
          .execute();

      final getPushSubscriptionResponse = response.parse<GetPushSubscriptionResponse>(
