...
void main() {
  group('Invalid reference_prefix', () {
    ...
    test('Should throw argument error when the reference_prefix has length more than 255', () {
      expect(
        () => ReferencePrefix('a123bde34588799922229339933933933993939393939222a123bde34'
