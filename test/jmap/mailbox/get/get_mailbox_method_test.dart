...
void main() {
  group('test to json get mailbox method', () {
    ...
    test('get mailbox method and response parsing has team mailboxes',
        () async {
      ...
      final getMailboxMethod = GetMailboxMethod(AccountId(Id(
          '0d14dbabe6482aff5cbf922e04cef51a40b4eabccbe12d28fe27c97038752555')));
    ...
    test('get mailbox method and response parsing not have team mailboxes',
        () async {
      final baseOption = BaseOptions(method: 'POST');
      final dio = Dio(baseOption)..options.baseUrl = 'http://domain.com/jmap';
      final dioAdapter =
