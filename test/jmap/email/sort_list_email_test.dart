...
void main() {
                    ...
                    "list": [
                      {
                        ...
                        "subject": "A",
                        "from": [
                          {"name": "DatPH", "email": "dphamhoang@linagora.com"}
                        ],
                      ...
                      },
                      {
                        ...
                        "subject": "D",
                        "from": [
                          {"name": "Haaheoo", "email": "userc@qa.open-paas.org"}
                        ],
          ...
          "methodCalls": [
            [
              "Email/query",
              {
                "accountId":
                    "3ce33c876a726662c627746eb9537a1d13c2338193ef27bd051a3ce5c0fe5b12",
                "filter": {"inMailbox": "aba7e8d0-18d9-11eb-a677-2990b970028d"},
                "sort": [
  ...
  group('sort list email test', () {
    ...
    test('sort list email by subject descending', () async {
      final listEmailResponse = await getListEmailAndSortBy(
          EmailComparator(EmailComparatorProperty.subject)
            ..setIsAscending(false));
      expect(
          listEmailResponse,
          containsAllInOrder([
