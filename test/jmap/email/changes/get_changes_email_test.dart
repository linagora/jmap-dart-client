...
void main() {
  group('[Email/changes]', () {
    final expectMail1 = Email(
        ...
        mailboxIds: {
          MailboxId(Id('aba7e8d0-18d9-11eb-a677-2990b970028d')): true
        },
        keywords: {
    ...
    test('get changes email', () async {
      ...
      final changesEmailInvocation = jmapRequestBuilder
          .invocation(changesEmailMethod, methodCallId: MethodCallId('c1'));
      ...
      final getEmailMethodForUpdate = GetEmailMethod(accountId)
        ...
        ..addReferenceIds(processingInvocation.createResultReference(
            changesEmailInvocation.methodCallId, ReferencePath('/updated')));
      ...
      final getEmailMethodForCreated = GetEmailMethod(accountId)
        ...
        ..addReferenceIds(processingInvocation.createResultReference(
            changesEmailInvocation.methodCallId, ReferencePath('/created')));
