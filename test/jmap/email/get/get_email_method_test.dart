...
void main() {
  group('[Email/get] test', () {
    ...
    test('get email method and response parsing with header Calendar Event',
        () async {
      ...
      final getEmailForCreatedInvocation =
          jmapRequestBuilder.invocation(getEmailMethodForCreated);
