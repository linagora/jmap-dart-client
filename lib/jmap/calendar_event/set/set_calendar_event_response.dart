...
class SetCalendarEventResponse extends SetResponse<CalendarEvent> {
  SetCalendarEventResponse(AccountId accountId,
      {State? newState,
      State? oldState,
      Map<Id, CalendarEvent>? created,
      Map<Id, CalendarEvent?>? updated,
      Set<Id>? destroyed,
  ...
  static SetCalendarEventResponse deserialize(Map<String, dynamic> json) {
