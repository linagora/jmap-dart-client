...
class SetCalendarEventMethod extends SetMethod<CalendarEvent> {
  SetCalendarEventMethod(AccountId accountId) : super(accountId);

  @override
  MethodName get methodName => MethodName('CalendarEvent/set');
