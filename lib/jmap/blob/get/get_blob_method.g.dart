...
part of 'get_blob_method.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetBlobMethod _$GetBlobMethodFromJson(Map<String, dynamic> json) =>
    GetBlobMethod(
...
Map<String, dynamic> _$GetBlobMethodToJson(GetBlobMethod instance) {
  ...
  writeNotNull(
    'ids',
    instance.ids?.map(const IdConverter().toJson).toList(),
  );
  ...
  writeNotNull(
    'properties',
    const PropertiesConverter().toJson(instance.properties),
  );
