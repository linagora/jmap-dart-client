...
class SetCalendarMethod extends SetMethod<Calendar> {
  SetCalendarMethod(AccountId accountId) : super(accountId);

  @override
  MethodName get methodName => MethodName('Calendar/set');
