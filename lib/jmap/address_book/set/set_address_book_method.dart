...
class SetAddressBookMethod extends SetMethod<AddressBook> {
  SetAddressBookMethod(AccountId accountId) : super(accountId);

  @override
  MethodName get methodName => MethodName('AddressBook/set');
