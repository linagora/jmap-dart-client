...
part 'changes_address_book_method.g.dart';

@UnsignedIntNullableConverter()
@StateConverter()
@AccountIdConverter()
@JsonSerializable()
class ChangesAddressBookMethod extends ChangesMethod {
  ...
  @override
  MethodName get methodName => MethodName('AddressBook/changes');
  ...
  factory ChangesAddressBookMethod.fromJson(Map<String, dynamic> json) =>
      _$ChangesAddressBookMethodFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$ChangesAddressBookMethodToJson(this);
}